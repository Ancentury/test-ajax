...
const smartyUrl = 'https://example-ajax-proxy.herokuapp.com/streets/street-address?candidates=10';
const smartyInit = {
  headers: {
...
const parksUrl = 'https://example-ajax-proxy.herokuapp.com/nps/api/v1/parks?stateCode=ca';
const parksFallback = {
